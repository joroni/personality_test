        ...
        <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
            <form name="signupForm" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    <input type="text" id="display_name" class="form-control input-lg" placeholder="User Name" ng-model="signup.user_name">
                </div>
                <div class="form-group">
                    <input type="text" id="first_name" class="form-control input-lg" placeholder="First Name" ng-model="signup.first_name">
                </div>
                <div class="form-group">
                    <input type="text" id="last_name" class="form-control input-lg" placeholder="Last Name" ng-model="signup.user_name">
                </div>
                <div class="form-group">
