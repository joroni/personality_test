...
//$scope.hid='';
 ...
 $scope.data = [];
  ...
  $scope.onSendClick = function(event)
  {
    ...
    $scope.userlinkparam;
    console.log($scope.userlinkparam);
    // let link = "http://localhost/personality_test/frontend/?email="+ userlinkparam.email+"&user_id="+userlinkparam.id+"&group_id="+userlinkparam.group_id;
