var app = angular.module("quiz", ['chart.js', 'datatables','ui.bootstrap']);


app.controller("quizAdmin", function ($scope, $http,$uibModal, $log) {
...
/* 
angular.module('quiz').controller('ModalDemoCtrl', function ($uibModal, $log) {
  var pc = this;
  pc.data = "Lorem Name Test"; 
...
angular.module('quiz').controller('ModalInstanceCtrl', function ($uibModalInstance, data) {
  var pc = this;
  pc.data = data;
