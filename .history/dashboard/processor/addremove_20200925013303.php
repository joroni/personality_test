...
if($request_type == 2){
    ...
    if($result->num_rows > 0){
       while($row = $result->fetch_assoc()) {
            $data[] = array("user_id"=>$row['user_id'],"user_earth"=>$row['user_earth'],"user_air"=>$row['user_air'],"user_water"=>$row['user_water'], "user_fire"=>$row['user_fire'],"group_id"=>$row['group_id'],"first_name"=>$row['first_name'],"last_name"=>$row['last_name'],user_id"=>$row['user_id'],user_id"=>$row['user_id'],user_id"=>$row['user_id']); 
        }
    }
