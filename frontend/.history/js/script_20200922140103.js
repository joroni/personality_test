...
app.controller("quizCtrl", function ($scope, $http) {
  ...
  */
  ...
  $scope.fetchGetVariables = function () {
    ...
    //var loc = "http://localhost/quizsample7b/page.html?email=jraymund.niconi@gmail.com&day=today&time=1100";
...
//$scope.userData = {};
  //userData = $scope.fetchGetVariables();
  // Get user
...
//  $scope.userdata.email  ={};
  $scope.getUserInfo = function () {
    for (let i = 0; i <= userdata.length; i++) {
      ...
      console.log('$scope.userdata.email', $scope.userdata.email);
...
console.log('user',$scope.fetchGetVariables());
  ...
  $scope.add = function (userdata) {
   //let newuserdata = {};
    ...
    $scope.user_id = $scope.fetchGetVariables().order;
...
/*    
 ...
 /*  $scope.collectData = function () {
  ...
  $scope.initData = function () {
    ...
    if ($scope.fetchGetVariables().email != value || !$scope.fetchGetVariables().order !=value || !$scope.fetchGetVariables().order){
      $scope.isTempo = true;
