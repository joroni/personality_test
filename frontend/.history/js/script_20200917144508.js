...
*/
 ...
 $scope.getCoeff = function(e) {
  ...
  // var $input = angular.element(e.target);
   var $input = angular.element(document).find('#MyAnswer1');
  // var $input = $inputA.hasClass('choice-list-group-item');
   ...
   angular.forEach($input.next().children(), function(child, index) {
     ...
     //  let txt = [];
       //txt = parseFloat($child.text());
       //console.log(txt);
       $scope.isanswer = [parseFloat($child.text())];
