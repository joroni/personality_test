...
app.controller("quizCtrl", function ($scope) {
  ...
  $scope.turninAnswer = function(categoriesArr){
   //plasticHeader = a;
   //a = this.$index;
   // let currentQuestion =$scope.data[$scope.index];
     return categoriesArr.map(function(curr) {
        return $scope.data.question.filter(function(el){
          console.log('Q-Index', categoriesArr);
            return el.$scope.selectedhead === curr; //filter out the appropriate category by id
