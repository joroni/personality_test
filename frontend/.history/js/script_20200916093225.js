...
$scope.submitAnswer = function(myAnswer){
  alert(myAnswer);
            ...
            $http({
                method: 'post',
                url: 'processor/addremove.php', url: 'addremove.php',
                data: {request_type:1},
           ...
           // $scope.answers = [];
            ...
            $scope.add = function(){
                ...
                data: {user_id:$scope.user_id,question_id:$scope.question_id,choice_id:$scope.choice_id,request_type:2,len:len},
                }).then(function successCallback(response) {
